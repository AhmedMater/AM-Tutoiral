...
CREATE TABLE `course` (
  ...
  `course_level` enum('Beginner','Medium','Advanced') NOT NULL,
  `course_type` enum('Academic','Parctical') NOT NULL,
  `playlist_link` varchar(150) NOT NULL,
...
CREATE TABLE `course_chapters` (
  ...
  CONSTRAINT `course_10_FK` FOREIGN KEY (`course`) REFERENCES `course` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `course_reference` (
  ...
  `url` varchar(150) NOT NULL COMMENT 'Link for a Course or a Book or a Lesson',
  PRIMARY KEY (`id`),
...
INSERT INTO `users` VALUES (1,'Ahmed_Mater','8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92','ahmed.motair@gmail.com',1,'2016-10-08 17:05:54','Ahmed','Mater','male',1,'Zagazig University','Engineering','Software Developer','Egypt',NULL,'Ahmed_Mater18112016641.gif',NULL);
...
-- Dump completed on 2016-11-20  5:39:53
