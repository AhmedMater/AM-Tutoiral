...
module.exports = {
    ...
    insertUser: function(userData, RESTCallBack) {
        ...
        if(userData.userName == null || userData.password == null || userData.confirmPassword == null ||
            ...
            return RESTCallBack(ErrMsg.createError(SystemParam.SERVER_ERROR, 400, ErrMsg.ERROR_2), null);
        }
            ...
            return RESTCallBack(ErrMsg.createError(SystemParam.SERVER_ERROR, 400, ErrMsg.ERROR_3), null);
        }
        else if(userData.password != userData.confirmPassword) {
            Logger.error(SystemParam.SERVICES, fnName, ErrMsg.ERROR_4);
            return RESTCallBack(ErrMsg.createError(SystemParam.SERVER_ERROR, 400, ErrMsg.ERROR_4), null);
        }
        else if(!RegExp.email.test(userData.email)) {
            Logger.error(SystemParam.SERVICES, fnName, ErrMsg.ERROR_5);
            return RESTCallBack(ErrMsg.createError(SystemParam.SERVER_ERROR, 400, ErrMsg.ERROR_5), null);
        }
        else if(!RegExp.name.test(userData.firstName)) {
            Logger.error(SystemParam.SERVICES, fnName, ErrMsg.ERROR_6);
            return RESTCallBack(ErrMsg.createError(SystemParam.SERVER_ERROR, 400, ErrMsg.ERROR_6), null);
        }
        else if(!RegExp.name.test(userData.lastName)) {
            Logger.error(SystemParam.SERVICES, fnName, ErrMsg.ERROR_7);
            return RESTCallBack(ErrMsg.createError(SystemParam.SERVER_ERROR, 400, ErrMsg.ERROR_7), null);
        }
        else if(!RegExp.gender.test(userData.gender)) {
            Logger.error(SystemParam.SERVICES, fnName, ErrMsg.ERROR_8);
            return RESTCallBack(ErrMsg.createError(SystemParam.SERVER_ERROR, 400, ErrMsg.ERROR_8), null);
        }
            ...
            return RESTCallBack(ErrMsg.createError(SystemParam.SERVER_ERROR, 400, ErrMsg.ERROR_12), null);
        }
            ...
            return RESTCallBack(ErrMsg.createError(SystemParam.SERVER_ERROR, 400, ErrMsg.ERROR_9), null);
        }
        else if(!RegExp.name.test(userData.university)) {
            Logger.error(SystemParam.SERVICES, fnName, ErrMsg.ERROR_10);
            return RESTCallBack(ErrMsg.createError(SystemParam.SERVER_ERROR, 400, ErrMsg.ERROR_10), null);
        }
