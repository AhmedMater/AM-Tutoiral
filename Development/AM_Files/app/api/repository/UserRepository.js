...
module.exports = {
    ...
    getUserByID: function(userID, RepositoryCallBack) {
        ...
        DB.query(query, function (err, rows, fields) {
            ...
            if(rows[0] == null) {
                Logger.error(SystemParam.REPOSITORY, fnName, 'Requested User isn\'t Found in Database');
                return RepositoryCallBack(ErrMsg.createError(SystemParam.DATABASE_ERROR, 400, 'Requested User isn\'t Found in Database'), null);
            }
